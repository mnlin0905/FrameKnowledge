...
//项目名称
app.name='FrameKnowledge';

//项目版本号
app.version='1.0.0';

//项目打包时候的应用id
app.applicationId='com.knowledge.mnlin.frame';

//最低支持的SDK版本号
app.minSdkVersion=21;

//项目创建时间
app.createTime=new Date('2017.10.9 8:30:00');

//最近一次更新时间
app.updateTime=new Date('2017.10.17 8:30:00');
...
app.catalogs={
    ...
    sub:[
        ...
        {
            path:'/com/knowledge/mnlin/frame',
